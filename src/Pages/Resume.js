            ...
            <nav className="flex md:mt-8">
             ...
             <div
                    ...
                    >
                        ...
                        <a href="https://cvdesignr.com/p/63777bedb5509" className="flex justify-center border mt-32 px-10 py-4 border-slate-900 rounded-lg text-slate-200 font-bold">Link to Resume</a>
                        </div>
                        </div>
